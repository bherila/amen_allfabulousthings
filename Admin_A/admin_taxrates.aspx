<%@ Page Language="vb" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="admin_taxrates.aspx.vb" Inherits="admin_taxrates" Title="Tax Rates" StylesheetTheme="White" %>
<asp:Content ID="Content1" ContentPlaceHolderID="AdminPlaceHolder" Runat="Server">
   <h1>Tax Rates</h1>
	...
	<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CommerceTemplate %>"
		SelectCommand="SELECT [rateID], [rate], [state], [zipCode] FROM [CMRC_TaxRates]" 
		DeleteCommand="DELETE FROM [CMRC_TaxRates] WHERE [rateID] = @rateID" 
		InsertCommand="INSERT INTO [CMRC_TaxRates] ([rate], [state], [zipCode]) VALUES (@rate, @state, @zipCode)" 
		UpdateCommand="UPDATE [CMRC_TaxRates] SET [rate] = @rate, [state] = @state, [zipCode] = @zipCode WHERE [rateID] = @rateID">
		<DeleteParameters>
