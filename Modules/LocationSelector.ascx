<%@ Control Language="vb" AutoEventWireup="false" Codefile="LocationSelector.ascx.vb" Inherits="LocationSelector" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
<TR>
	<TD width="148" class="checkoutlabel">State/Region</TD>
	<TD>
...
<TR>
	<TD width="148" class="checkoutlabel">Country</TD>
	<TD>
